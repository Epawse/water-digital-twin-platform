...
\n\
// Globe filter uniforms (custom extension for tech/ink style)\n\
uniform bool u_globeFilterEnabled;\n\
uniform vec3 u_globeFilterColor;\n\
uniform float u_globeFilterExposure;\n\
uniform float u_globeFilterContrast;\n\
\n\
#if TEXTURE_UNITS > 0\n\
...
#endif\n\
\n\
    // Globe filter effect: grayscale -> invert -> contrast -> exposure -> tint\n\
    if (u_globeFilterEnabled) {\n\
        float gray = dot(color, vec3(0.299, 0.587, 0.114));\n\
        color = vec3(gray);\n\
        color = 1.0 - color;\n\
        color = (color - 0.5) * u_globeFilterContrast + 0.5;\n\
        color *= u_globeFilterExposure;\n\
        color *= u_globeFilterColor;\n\
    }\n\
\n\
