...
function Globe(ellipsoid) {
  ...
  this._filterColor = new Cartesian3(1.0, 1.0, 1.0);
  this._filterExposure = 1.0;
  this._filterContrast = 1.0;
...
Object.defineProperties(Globe.prototype, {
  ...
  /**
   * Enable/disable globe filter effect (grayscale, invert, tint).
   * This is a custom extension for tech/ink style map rendering.
   *
   * @memberof Globe.prototype
   * @type {boolean}
   * @default false
  ...
  filterEnabled: {
    ...
    set: function (value) {
      ...
      this._surface._tileProvider.filterEnabled = value;
    },
  },

  /**
   * The filter tint color as Cartesian3 (r, g, b normalized 0-1).
   * This is a custom extension for tech/ink style map rendering.
   *
   * @memberof Globe.prototype
   * @type {Cartesian3}
  ...
  filterColor: {
    ...
    set: function (value) {
      this._filterColor = Cartesian3.clone(value, this._filterColor);
      Cartesian3.clone(value, this._surface._tileProvider.filterColor);
    },
  },

  /**
   * Filter exposure multiplier.
   * This is a custom extension for tech/ink style map rendering.
   *
   * @memberof Globe.prototype
   * @type {number}
  ...
  filterExposure: {
    get: function () {
      return this._filterExposure;
    },
    set: function (value) {
      this._filterExposure = value;
      this._surface._tileProvider.filterExposure = value;
    },
  },
  ...
  filterContrast: {
    ...
    set: function (value) {
      ...
      this._surface._tileProvider.filterContrast = value;
    },
  },
});
