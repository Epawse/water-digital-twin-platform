  ...
  <header class="top-ribbon">
    ...
    <div class="right-tools">
      ...
      <div class="tool-group">
        <button class="btn-icon-text" title="空间测距"><i class="fa-solid fa-ruler"></i></button>
        <button class="btn-icon-text" title="面积测量"><i class="fa-solid fa-draw-polygon"></i></button>
        <button class="btn-icon-text" title="地形剖面"><i class="fa-solid fa-chart-area"></i></button>
        <button class="btn-icon-text" title="淹没分析"><i class="fa-solid fa-water"></i></button>
      </div>
            ...
            <div v-show="isMapPanelVisible" class="map-control-panel">
              ...
              <div class="panel-section">
                ...
                <div class="basemap-grid">
                  ...
                  <div class="basemap-item" :class="{ active: mapType === 'tdt_vec' }" @click="selectBasemap('tdt_vec')">
                    <div class="thumb vec"></div>
                    <span>矢量</span>
                  </div>
                  <div class="basemap-item" :class="{ active: mapType === 'tdt_ter' }" @click="selectBasemap('tdt_ter')">
                    <div class="thumb ter"></div>
                    <span>地形</span>
                  </div>
                  <div class="basemap-item" :class="{ active: mapType === 'tdt_img' }" @click="selectBasemap('tdt_img')">
